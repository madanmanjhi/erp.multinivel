...
$erplink = "http://oficinavirtual.korak.mx/auth/login";
...
try {
	...
	$Destination = 'contacto@korak.mx';
	$Subject = 'BIENVENIDO A korak.mx';
	$Content = '
...
$mail->IsSMTP();                           // tell the class to use SMTP
	...
	$mail->From       = 'contacto@korak.mx';
	$mail->FromName   = "korak.mx";
